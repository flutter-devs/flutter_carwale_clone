                ...
                builder: (BuildContext context, BoxConstraints constraints) {
                  ...
                  return FlexibleSpaceBar(
                    ...
                    background: Image.asset(
                      'assets/images/background-img.jpg',
                      height: _height / 2.5,
                      fit: BoxFit.fill,
                    ),
                  );
                            ...
                            child: Stack(
                              children: <Widget>[
                                Container(
                                  ...
                                  width: _width,
                                  child: Image.asset(
                                      'assets/images/MarutiSCross.jpg'),
                                ),
                                Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  alignment: Alignment.center,
                                  child: Text(
                                    'India First Pure Electric Internet Car.',
                                    style: TextStyle(
                              ...
                              Stack(
                                children: <Widget>[
                                  ...
                                  Container(
                                    alignment: Alignment.topCenter,
                                    margin:
                                        EdgeInsets.only(left: 40.0, right: 0.0),
                                    height: _height / 9,
                                    width: _width / 4.5,
                                    child: CircleAvatar(
                                      radius: 51,
...
// border: Border.all(width: 1.0, color: Colors.green),
              ...
              Container(
                ...
                child: Stack(
                  children: <Widget>[
                    Image.asset(
                      'assets/images/check_onroad.webp',
                      fit: BoxFit.fill,
                      width: _width,
                      height: _height,
                    ),
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Container(
                          padding:
                              EdgeInsets.only(left: 0.0, bottom: 0.0, top: 5.0),
                          alignment: Alignment.topLeft,
                          child: Text(
                            item.showroom_price,
                            style: TextStyle(
            ...
            Expanded(
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/car_comparison.jpg',
                    fit: BoxFit.fill,
                  ),
                ),
              ),
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    height: _height / 10.0,
                    padding:
                        EdgeInsets.only(left: 10.0, bottom: 0.0, top: 20.0),
                    alignment: Alignment.topCenter,
                    child: Text(
                      item.title,
                      style: TextStyle(
                ...
                Expanded(
                  child: Container(
                    height: _height / 10.0,
                    padding: EdgeInsets.only(
                        left: 20.0, bottom: 0.0, top: 20.0, right: 10.0),
                    alignment: Alignment.topCenter,
                    child: Text(
                      item.subTitle,
                      style: TextStyle(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          padding:
                              EdgeInsets.only(left: 5.0, bottom: 0.0, top: 5.0),
                          alignment: Alignment.topLeft,
                          child: Text(
                            'onwards',
                            style: TextStyle(
            ...
            Column(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        top: 5.0, left: 10.0, right: 20.0, bottom: 10.0),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        Container(
            ...
            Column(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsets.only(top: 8.0, left: 15.0, bottom: 10.0),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: <Widget>[
                        Container(
